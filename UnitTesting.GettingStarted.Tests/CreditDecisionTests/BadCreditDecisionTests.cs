...
namespace UnitTesting.GettingStarted.Tests.CreditDecisionTests
{
    ...
    ************************************************************/
    ...
    {
        private readonly CreditDecisionService _creditDecisionService = new();
        ...
        public void MakeCreditDecision_Always_ReturnsExpectedResult(int creditScore, string expectedResult)
        {
            ...
            systemUnderTest = new CreditDecision.CreditDecision(_creditDecisionService);
            
            // Each time we execute this method, it will take 2.5 seconds before we get a result
